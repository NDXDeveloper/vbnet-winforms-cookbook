...
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Tableur .xlsx - galerie de demonstration"
        ...
        Dim pnlGauche As New Panel() With {.Dock = DockStyle.Left, .Width = 240, .BackColor = Color.FromArgb(236, 245, 238)}
        Dim lblTitre As New Label() With {
            .Text = "Tableur", .Dock = DockStyle.Top, .Height = 44,
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Tableur (.xlsx)", Function() New PageTableur()))
        _lstNav.Items.Add(New ElementNav("Données (base ↔ xlsx)", Function() New PageDonnees()))
    ...
    Public Shared ReadOnly Property CouleurAccent As Color
        Get
            Return Color.FromArgb(255, 27, 94, 32)
        End Get
    End Property
