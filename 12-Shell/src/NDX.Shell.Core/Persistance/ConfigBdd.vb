' ============================================================================
'  ConfigBdd.vb  -  Configuration d'acces a la base "catalogue_liens".
...
''' <summary>Chaine de connexion (cles <c>Bdd.*</c> ; defaut = conteneur Docker, port 3317).</summary>
Public Module ConfigBdd

    Private Const SERVEUR_DEFAUT As String = "127.0.0.1"
    Private Const PORT_DEFAUT As UInteger = 3317UI
    Private Const BASE_DEFAUT As String = "catalogue_liens"
    Private Const UTILISATEUR_DEFAUT As String = "catalogue_app"
    Private Const MOTDEPASSE_DEFAUT As String = "catalogue_pwd"
