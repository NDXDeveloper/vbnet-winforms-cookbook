' ============================================================================
'  PageBase.vb
'  Classe de base des pages de la galerie : en-tete + zone de contenu.
'
...
''' <summary>Classe de base : en-tete (titre + description) et zone de contenu.</summary>
Public MustInherit Class PageBase
    ...
    Protected Sub New(ByVal titre As String, ByVal description As String)
        ...
        Dim lblTitre As New Label() With {
            ...
            .Dock = DockStyle.Top, .Height = 34, .TextAlign = ContentAlignment.BottomLeft,
    ...
    ''' <summary>Fabrique une zone de texte de sortie (lecture seule, police a chasse fixe).</summary>
