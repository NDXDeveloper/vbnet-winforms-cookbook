...
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Instance unique & IPC - galerie de demonstration"
        ...
        Dim pnlGauche As New Panel() With {.Dock = DockStyle.Left, .Width = 240, .BackColor = Color.FromArgb(250, 236, 242)}
        Dim lblTitre As New Label() With {
            .Text = "Instance unique", .Dock = DockStyle.Top, .Height = 44,
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Instance & messages", Function() New PageInstance()))
        _lstNav.Items.Add(New ElementNav("Journal (base)", Function() New PageJournal()))
    ...
    Public Shared ReadOnly Property CouleurAccent As Color
        Get
            Return Color.FromArgb(255, 173, 20, 87)
        End Get
    End Property
