...
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Accès aux données - galerie de demonstration"
        ...
        Dim pnlGauche As New Panel() With {.Dock = DockStyle.Left, .Width = 240, .BackColor = Color.FromArgb(246, 244, 249)}
        Dim lblTitre As New Label() With {
            .Text = "Accès aux données", .Dock = DockStyle.Top, .Height = 44,
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Catalogue (Repository)", Function() New PageCatalogue()))
        _lstNav.Items.Add(New ElementNav("Transaction (Unit of Work)", Function() New PageTransaction()))
    ...
    Public Shared ReadOnly Property CouleurAccent As Color
        Get
            Return Color.FromArgb(255, 92, 60, 130)
        End Get
    End Property
