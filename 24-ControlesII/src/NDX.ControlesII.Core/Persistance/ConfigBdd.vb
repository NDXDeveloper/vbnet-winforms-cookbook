' ============================================================================
'  ConfigBdd.vb  -  Configuration d'acces a la base "inventaire".
...
''' <summary>Chaine de connexion (cles <c>Bdd.*</c> ; defaut = conteneur Docker, port 3329).</summary>
Public Module ConfigBdd

    Private Const SERVEUR_DEFAUT As String = "127.0.0.1"
    Private Const PORT_DEFAUT As UInteger = 3329UI
    Private Const BASE_DEFAUT As String = "inventaire"
    Private Const UTILISATEUR_DEFAUT As String = "inventaire_app"
    Private Const MOTDEPASSE_DEFAUT As String = "inventaire_pwd"
