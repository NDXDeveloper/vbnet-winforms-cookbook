...
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Contrôles avancés - galerie de demonstration"
        ...
        Dim pnlGauche As New Panel() With {.Dock = DockStyle.Left, .Width = 240, .BackColor = Color.FromArgb(232, 244, 250)}
        Dim lblTitre As New Label() With {
            .Text = "Contrôles II", .Dock = DockStyle.Top, .Height = 44,
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Boutons à états", Function() New PageBoutons()))
        _lstNav.Items.Add(New ElementNav("Onglets peints", Function() New PageOnglets()))
        _lstNav.Items.Add(New ElementNav("Grille (base)", Function() New PageGrille()))
    ...
    Public Shared ReadOnly Property CouleurAccent As Color
        Get
            Return Color.FromArgb(255, 2, 136, 209)
        End Get
    End Property
