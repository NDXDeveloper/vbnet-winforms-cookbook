...
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Traitement d'images - galerie de demonstration"
        ...
        Dim pnlGauche As New Panel() With {.Dock = DockStyle.Left, .Width = 240, .BackColor = Color.FromArgb(250, 243, 236)}
        Dim lblTitre As New Label() With {
            .Text = "Images", .Dock = DockStyle.Top, .Height = 44,
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Filtres (avant/après)", Function() New PageFiltres()))
        _lstNav.Items.Add(New ElementNav("Médiathèque (base)", Function() New PageMediatheque()))
    ...
    Public Shared ReadOnly Property CouleurAccent As Color
        Get
            Return Color.FromArgb(255, 245, 124, 0)
        End Get
    End Property
