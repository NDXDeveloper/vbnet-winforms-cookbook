' ============================================================================
'  PageHistorique.vb  -  Historique des releves (base).
...
''' <summary>Liste les relevés de supervision enregistrés en base.</summary>
Public NotInheritable Class PageHistorique
    ...
    Public Sub New()
        MyBase.New("Historique (base)", "Relevés enregistrés depuis la page Supervision (objets GDI/USER et inactivité).")
        Construire()
    End Sub
    ...
    Private Sub SurLister(ByVal sender As Object, ByVal e As EventArgs)
        Try
            _grille.DataSource = DepotSupervision.ListerTable()
