...
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Interopérabilité Windows - galerie de demonstration"
        ...
        Dim pnlGauche As New Panel() With {.Dock = DockStyle.Left, .Width = 240, .BackColor = Color.FromArgb(238, 241, 242)}
        Dim lblTitre As New Label() With {
            .Text = "Interop Win32", .Dock = DockStyle.Top, .Height = 44,
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Supervision (temps réel)", Function() New PageSupervision()))
        _lstNav.Items.Add(New ElementNav("Historique (base)", Function() New PageHistorique()))
    ...
    Public Shared ReadOnly Property CouleurAccent As Color
        Get
            Return Color.FromArgb(255, 55, 71, 79)
        End Get
    End Property
