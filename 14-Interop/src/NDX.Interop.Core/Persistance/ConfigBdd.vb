' ============================================================================
'  ConfigBdd.vb  -  Configuration d'acces a la base "supervision".
...
''' <summary>Chaine de connexion (cles <c>Bdd.*</c> ; defaut = conteneur Docker, port 3319).</summary>
Public Module ConfigBdd

    Private Const SERVEUR_DEFAUT As String = "127.0.0.1"
    Private Const PORT_DEFAUT As UInteger = 3319UI
    Private Const BASE_DEFAUT As String = "supervision"
    Private Const UTILISATEUR_DEFAUT As String = "supervision_app"
    Private Const MOTDEPASSE_DEFAUT As String = "supervision_pwd"
