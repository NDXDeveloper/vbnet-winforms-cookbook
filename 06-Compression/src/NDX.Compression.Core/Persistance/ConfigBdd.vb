' ============================================================================
'  ConfigBdd.vb  -  Configuration d'acces a la base "archive".
...
''' <summary>Chaine de connexion (cles <c>Bdd.*</c> ; defaut = conteneur Docker, port 3312).</summary>
Public Module ConfigBdd

    Private Const SERVEUR_DEFAUT As String = "127.0.0.1"
    Private Const PORT_DEFAUT As UInteger = 3312UI
    Private Const BASE_DEFAUT As String = "archive"
    Private Const UTILISATEUR_DEFAUT As String = "archive_app"
    Private Const MOTDEPASSE_DEFAUT As String = "archive_pwd"
