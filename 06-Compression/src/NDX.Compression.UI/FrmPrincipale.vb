...
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Compression de données - galerie de demonstration"
        ...
        Dim pnlGauche As New Panel() With {.Dock = DockStyle.Left, .Width = 240, .BackColor = Color.FromArgb(238, 246, 244)}
        Dim lblTitre As New Label() With {
            .Text = "Compression", .Dock = DockStyle.Top, .Height = 44,
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Compression (mémoire)", Function() New PageCompression()))
        _lstNav.Items.Add(New ElementNav("Archives (base)", Function() New PageArchives()))
    ...
    Public Shared ReadOnly Property CouleurAccent As Color
        Get
            Return Color.FromArgb(255, 0, 121, 107)
        End Get
    End Property
