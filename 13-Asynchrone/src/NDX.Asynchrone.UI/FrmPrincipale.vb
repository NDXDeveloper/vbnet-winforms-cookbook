...
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Traitements asynchrones - galerie de demonstration"
        ...
        Dim pnlGauche As New Panel() With {.Dock = DockStyle.Left, .Width = 240, .BackColor = Color.FromArgb(238, 240, 250)}
        Dim lblTitre As New Label() With {
            .Text = "Asynchrone", .Dock = DockStyle.Top, .Height = 44,
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Progression / annulation", Function() New PageProgression()))
        _lstNav.Items.Add(New ElementNav("File de tâches (base)", Function() New PageFile()))
    ...
    Public Shared ReadOnly Property CouleurAccent As Color
        Get
            Return Color.FromArgb(255, 57, 73, 171)
        End Get
    End Property
