' ============================================================================
'  ConfigBdd.vb  -  Configuration d'acces a la base "atelier".
...
''' <summary>Chaine de connexion (cles <c>Bdd.*</c> ; defaut = conteneur Docker, port 3327).</summary>
Public Module ConfigBdd

    Private Const SERVEUR_DEFAUT As String = "127.0.0.1"
    Private Const PORT_DEFAUT As UInteger = 3327UI
    Private Const BASE_DEFAUT As String = "atelier"
    Private Const UTILISATEUR_DEFAUT As String = "atelier_app"
    Private Const MOTDEPASSE_DEFAUT As String = "atelier_pwd"
