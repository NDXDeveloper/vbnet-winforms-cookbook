...
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Éditeur de formes - galerie de demonstration"
        ...
        Dim pnlGauche As New Panel() With {.Dock = DockStyle.Left, .Width = 240, .BackColor = Color.FromArgb(245, 238, 247)}
        Dim lblTitre As New Label() With {
            .Text = "Dessin", .Dock = DockStyle.Top, .Height = 44,
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Canevas", Function() New PageCanevas()))
        _lstNav.Items.Add(New ElementNav("Formes (base)", Function() New PageFormes()))
    ...
    Public Shared ReadOnly Property CouleurAccent As Color
        Get
            Return Color.FromArgb(255, 106, 27, 154)
        End Get
    End Property
