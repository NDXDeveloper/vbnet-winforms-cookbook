...
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Composition de PDF - galerie de demonstration"
        ...
        Dim pnlGauche As New Panel() With {.Dock = DockStyle.Left, .Width = 240, .BackColor = Color.FromArgb(249, 240, 240)}
        Dim lblTitre As New Label() With {
            .Text = "PDF", .Dock = DockStyle.Top, .Height = 44,
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Composer un PDF", Function() New PageGenerer()))
        _lstNav.Items.Add(New ElementNav("Bibliothèque (base)", Function() New PageBibliotheque()))
    ...
    Public Shared ReadOnly Property CouleurAccent As Color
        Get
            Return Color.FromArgb(255, 183, 28, 28)
        End Get
    End Property
