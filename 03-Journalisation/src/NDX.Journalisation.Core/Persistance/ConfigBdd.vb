' ============================================================================
'  ConfigBdd.vb
'  Configuration d'acces a la base de demonstration (MariaDB "journal").
'
...
''' <summary>Chaine de connexion (cles <c>Bdd.*</c> d'App.config ; defaut = conteneur Docker, port 3309).</summary>
Public Module ConfigBdd

    Private Const SERVEUR_DEFAUT As String = "127.0.0.1"
    Private Const PORT_DEFAUT As UInteger = 3309UI
    Private Const BASE_DEFAUT As String = "journal"
    Private Const UTILISATEUR_DEFAUT As String = "journal_app"
    Private Const MOTDEPASSE_DEFAUT As String = "journal_pwd"
