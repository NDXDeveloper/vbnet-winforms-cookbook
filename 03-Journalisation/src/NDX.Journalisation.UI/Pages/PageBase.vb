...
Public MustInherit Class PageBase
    ...
    Protected Function Console() As TextBox
        Return New TextBox() With {.Multiline = True, .ReadOnly = True, .ScrollBars = ScrollBars.Both,
            .WordWrap = False, .Dock = DockStyle.Fill, .BackColor = Color.FromArgb(248, 248, 248),
