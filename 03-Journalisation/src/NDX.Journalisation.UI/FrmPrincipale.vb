...
''' <summary>Fenetre principale de la galerie (interface construite par code).</summary>
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Journalisation - galerie de demonstration"
        ...
        Dim pnlGauche As New Panel() With {.Dock = DockStyle.Left, .Width = 240, .BackColor = Color.FromArgb(245, 247, 246)}
        Dim lblTitre As New Label() With {
            .Text = "Journalisation", .Dock = DockStyle.Top, .Height = 44,
            .TextAlign = ContentAlignment.MiddleCenter, .Font = New Font("Segoe UI Semibold", 11.0F),
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Journalisation en direct", Function() New PageJournal()))
        _lstNav.Items.Add(New ElementNav("Journal en base", Function() New PageJournalBase()))
    ...
    Public Shared ReadOnly Property CouleurAccent As Color
        Get
            Return Color.FromArgb(255, 38, 92, 80)
        End Get
    End Property
