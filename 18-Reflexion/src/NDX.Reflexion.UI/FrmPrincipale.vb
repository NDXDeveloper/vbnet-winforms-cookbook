...
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Réflexion & métaprogrammation - galerie de demonstration"
        ...
        Dim pnlGauche As New Panel() With {.Dock = DockStyle.Left, .Width = 240, .BackColor = Color.FromArgb(240, 238, 248)}
        Dim lblTitre As New Label() With {
            .Text = "Réflexion", .Dock = DockStyle.Top, .Height = 44,
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Inspecteur de type", Function() New PageInspecteur()))
        _lstNav.Items.Add(New ElementNav("Outils (copie, purge)", Function() New PageOutils()))
        _lstNav.Items.Add(New ElementNav("Catalogue (base)", Function() New PageCatalogue()))
    ...
    Public Shared ReadOnly Property CouleurAccent As Color
        Get
            Return Color.FromArgb(255, 49, 27, 146)
        End Get
    End Property
