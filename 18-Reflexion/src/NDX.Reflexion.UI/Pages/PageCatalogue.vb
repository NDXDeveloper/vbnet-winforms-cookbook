' ============================================================================
'  PageCatalogue.vb  -  Catalogue des membres decouverts (base).
...
''' <summary>Liste les descripteurs de membres catalogués en base.</summary>
Public NotInheritable Class PageCatalogue
    ...
    Public Sub New()
        MyBase.New("Catalogue (base)", "Membres de types catalogués depuis la page Inspecteur.")
        Construire()
    End Sub
    ...
    Private Sub SurLister(ByVal sender As Object, ByVal e As EventArgs)
        Try
            _grille.DataSource = DepotMetadonnees.ListerTable()
            _lblEtat.Text = ""
