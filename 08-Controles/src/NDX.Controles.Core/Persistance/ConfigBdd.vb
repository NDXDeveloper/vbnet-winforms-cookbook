' ============================================================================
'  ConfigBdd.vb  -  Configuration d'acces a la base "preferences".
...
''' <summary>Chaine de connexion (cles <c>Bdd.*</c> ; defaut = conteneur Docker, port 3314).</summary>
Public Module ConfigBdd

    Private Const SERVEUR_DEFAUT As String = "127.0.0.1"
    Private Const PORT_DEFAUT As UInteger = 3314UI
    Private Const BASE_DEFAUT As String = "preferences"
    Private Const UTILISATEUR_DEFAUT As String = "preferences_app"
    Private Const MOTDEPASSE_DEFAUT As String = "preferences_pwd"
