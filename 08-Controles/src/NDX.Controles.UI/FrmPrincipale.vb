...
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Contrôles personnalisés - galerie de demonstration"
        ...
        Dim pnlGauche As New Panel() With {.Dock = DockStyle.Left, .Width = 240, .BackColor = Color.FromArgb(243, 240, 249)}
        Dim lblTitre As New Label() With {
            .Text = "Contrôles", .Dock = DockStyle.Top, .Height = 44,
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Interrupteur (owner-draw)", Function() New PageBascule()))
        _lstNav.Items.Add(New ElementNav("Visionneuse (zoom/pan)", Function() New PageVisionneuse()))
        _lstNav.Items.Add(New ElementNav("Préférences (base)", Function() New PagePreferences()))
    ...
    Public Shared ReadOnly Property CouleurAccent As Color
        Get
            Return Color.FromArgb(255, 94, 53, 177)
        End Get
    End Property
