...
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Graphiques de données - galerie de demonstration"
        ...
        Dim pnlGauche As New Panel() With {.Dock = DockStyle.Left, .Width = 240, .BackColor = Color.FromArgb(232, 246, 248)}
        Dim lblTitre As New Label() With {
            .Text = "Graphiques", .Dock = DockStyle.Top, .Height = 44,
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Graphique", Function() New PageGraphique()))
        _lstNav.Items.Add(New ElementNav("Mesures (base)", Function() New PageMesures()))
    ...
    Public Shared ReadOnly Property CouleurAccent As Color
        Get
            Return Color.FromArgb(255, 0, 151, 167)
        End Get
    End Property
