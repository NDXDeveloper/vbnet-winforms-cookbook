...
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Arborescence - galerie de demonstration"
        ...
        Dim lblTitre As New Label() With {
            .Text = "Arborescence", .Dock = DockStyle.Top, .Height = 44,
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Arbre (TreeView)", Function() New PageArbre()))
        _lstNav.Items.Add(New ElementNav("Descendants (récursif)", Function() New PageDescendants()))
