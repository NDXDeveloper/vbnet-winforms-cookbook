...
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Démarrage applicatif - galerie de demonstration"
        ...
        Dim pnlGauche As New Panel() With {.Dock = DockStyle.Left, .Width = 240, .BackColor = Color.FromArgb(236, 239, 241)}
        Dim lblTitre As New Label() With {
            .Text = "Démarrage", .Dock = DockStyle.Top, .Height = 44,
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Séquence de démarrage", Function() New PageDemarrage()))
        _lstNav.Items.Add(New ElementNav("Exceptions & journal", Function() New PageExceptions()))
