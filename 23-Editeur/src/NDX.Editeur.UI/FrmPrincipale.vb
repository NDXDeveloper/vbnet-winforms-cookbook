...
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Éditeur de texte enrichi - galerie de demonstration"
        ...
        Dim pnlGauche As New Panel() With {.Dock = DockStyle.Left, .Width = 240, .BackColor = Color.FromArgb(235, 242, 250)}
        Dim lblTitre As New Label() With {
            .Text = "Éditeur", .Dock = DockStyle.Top, .Height = 44,
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Éditeur RTF", Function() New PageEditeur()))
        _lstNav.Items.Add(New ElementNav("Documents (base)", Function() New PageDocuments()))
    ...
    Public Shared ReadOnly Property CouleurAccent As Color
        Get
            Return Color.FromArgb(255, 25, 118, 210)
        End Get
    End Property
