' ============================================================================
'  ConfigBdd.vb  -  Configuration d'acces a la base "entrepot".
...
''' <summary>Chaine de connexion (cles <c>Bdd.*</c> d'App.config ; defaut = conteneur Docker, port 3310).</summary>
Public Module ConfigBdd

    Private Const SERVEUR_DEFAUT As String = "127.0.0.1"
    Private Const PORT_DEFAUT As UInteger = 3310UI
    Private Const BASE_DEFAUT As String = "entrepot"
    Private Const UTILISATEUR_DEFAUT As String = "entrepot_app"
    Private Const MOTDEPASSE_DEFAUT As String = "entrepot_pwd"
