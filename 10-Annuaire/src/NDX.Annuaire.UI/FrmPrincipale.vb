...
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Annuaire LDAP - galerie de demonstration"
        ...
        Dim pnlGauche As New Panel() With {.Dock = DockStyle.Left, .Width = 240, .BackColor = Color.FromArgb(236, 246, 247)}
        Dim lblTitre As New Label() With {
            .Text = "Annuaire", .Dock = DockStyle.Top, .Height = 44,
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Connexion", Function() New PageConnexion()))
        _lstNav.Items.Add(New ElementNav("Annuaire (comptes)", Function() New PageAnnuaire()))
    ...
    Public Shared ReadOnly Property CouleurAccent As Color
        Get
            Return Color.FromArgb(255, 0, 131, 143)
        End Get
    End Property
