' ============================================================================
'  ConfigBdd.vb  -  Configuration d'acces a la base "deploiement".
...
''' <summary>Chaine de connexion (cles <c>Bdd.*</c> ; defaut = conteneur Docker, port 3313).</summary>
Public Module ConfigBdd

    Private Const SERVEUR_DEFAUT As String = "127.0.0.1"
    Private Const PORT_DEFAUT As UInteger = 3313UI
    Private Const BASE_DEFAUT As String = "deploiement"
    Private Const UTILISATEUR_DEFAUT As String = "deploiement_app"
    Private Const MOTDEPASSE_DEFAUT As String = "deploiement_pwd"
