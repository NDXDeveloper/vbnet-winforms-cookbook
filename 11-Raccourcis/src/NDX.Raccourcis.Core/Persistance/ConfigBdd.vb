' ============================================================================
'  ConfigBdd.vb  -  Configuration d'acces a la base "raccourcis".
...
''' <summary>Chaine de connexion (cles <c>Bdd.*</c> ; defaut = conteneur Docker, port 3316).</summary>
Public Module ConfigBdd

    Private Const SERVEUR_DEFAUT As String = "127.0.0.1"
    Private Const PORT_DEFAUT As UInteger = 3316UI
    Private Const BASE_DEFAUT As String = "raccourcis"
    Private Const UTILISATEUR_DEFAUT As String = "raccourcis_app"
    Private Const MOTDEPASSE_DEFAUT As String = "raccourcis_pwd"
