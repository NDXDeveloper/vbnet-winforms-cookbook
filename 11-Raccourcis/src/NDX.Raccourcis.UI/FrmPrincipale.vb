...
Public Class FrmPrincipale
    ...
    Private Sub InitialiserComposants()
        Me.Text = "Raccourcis clavier - galerie de demonstration"
        ...
        Dim pnlGauche As New Panel() With {.Dock = DockStyle.Left, .Width = 240, .BackColor = Color.FromArgb(240, 243, 245)}
        Dim lblTitre As New Label() With {
            .Text = "Raccourcis", .Dock = DockStyle.Top, .Height = 44,
    ...
    Private Sub RemplirNavigation()
        ...
        _lstNav.Items.Add(New ElementNav("Démonstration (accords)", Function() New PageDemo()))
        _lstNav.Items.Add(New ElementNav("Liaisons (base)", Function() New PageLiaisons()))
    ...
    Public Shared ReadOnly Property CouleurAccent As Color
        Get
            Return Color.FromArgb(255, 84, 110, 122)
        End Get
    End Property
